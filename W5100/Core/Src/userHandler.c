...
uint8_t predefined_get_cgi_prcs(uint8_t * uri_name, uint8_t * buf, uint16_t * len)
{
...
uint8_t predefined_set_cgi_prcs(uint8_t * uri_name, uint8_t * uri, uint8_t * buf, uint16_t * len)
{
	uint8_t ret = 1;	// ret = '1' means 'uri_name' matched
	uint8_t val = 0;
